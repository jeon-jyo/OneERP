...
$(document).ready(function() {
    ...
    /* 검색기능 S */
     $("#keyword").keyup(function() {
         var k = $(this).val();
         console.log(k);
         $("#estimate_list > tbody > tr").hide();
         var temp = $("#estimate_list > tbody > tr > td:contains('" + k + "')");
         $(temp).parent().show();
    }); 
    /* 검색기능 E */
...
<script type="text/javascript">
   $(function(){
      ...
      $('#estimate_list tr td').click(function(){
          ...
          console.log(tr);
          var tdd = tr.children();
         window.location="${path}/estimate_detail.sc?request_id="+tdd.eq(0).text();
      });
   });
</script>
<script>
        ...
        <div class="d-flex flex-row align-items-center">
          ...
          <div class="row col-lg-11">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="d-sm-flex justify-content-between">
                  <h3 class="card-title">견적서 관리</h3>
                       	...
                       	견적서 목록다운로드<i class="ti-printer btn-icon-append"></i>
                 	 </button>   
              ...
              <div class="table-responsive" id="estimate_list3">
                    <table class="table table-hover" id="estimate_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                      <thead>
                        <tr class="table-secondary">        
                          <th>견적 번호<i class="mdi mdi-swap-vertical"></i></th>
