             ...
             <!-- 이름 -->  
              ...
              <div class="form-group">
               ...
               <input type="number" class="form-control" maxlength="3" name="phone1" value="${fn:substring(dto.cl_phone,0,3)}" required oninput="numberMaxLength(this);"/> 
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="number" class="form-control" maxlength="4" name="phone2"  value="${fn:substring(dto.register_num,3,7)}"  required oninput="numberMaxLength(this);"/>
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="number" class="form-control" maxlength="4" name="phone3" value="${fn:substring(dto.register_num,7,11)}"  required oninput="numberMaxLength(this);"/>
                </div>
              </div>        
              <div class="form-group">
