          ...
          <div class="row col-lg-11">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                  ...
                  <div class="d-sm-flex justify-content-between mb-4">
                     ...
                     <div class="d-flex justify-content-end mt-3 mb-3">
		                <button type="button"class="btn btn-outline-facebook btn-rounded btn-icon-text" id="estimate_print" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
		                   		견적서 신청 목록다운로드<i class="ti-printer btn-icon-append"></i>
		                 </button>
              		 </div>
               ...
               <div class="d-flex justify-content-end mt-3 mb-3">
                  <button type="submit" class="btn btn-rounded btn-outline-twitter btn-fw" id="estimate_delete" onclick="history.back(); return false;" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                       삭제
                  </button>&nbsp;&nbsp;     
