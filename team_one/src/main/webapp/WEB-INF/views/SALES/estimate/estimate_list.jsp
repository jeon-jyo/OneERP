...
<script type="text/javascript">
   $(function(){
      ...
      $('#estimate_insert').click(function(){
	      ...
	      var url = "${path}/estimate_insert.jh";
	      
	      window.open(url, "estimate_insert", "menubar=no, width=850px, height=800px");  // (url, "별칭", size);  
       }); 
   });
</script>
<script type="text/javascript">
   $(function(){
	      ...
	      $('#estimate_list tr td').click(function(){
	         ...
	         window.location="${path}/estimate_detail.jh?request_id="+ tdd.eq(0).text();
	      });
	});   
</script>
<script>
          ...
          <div class="row col-lg-11">
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <div class="table-responsive">
                    <table class="table table-hover" id="estimate_list2" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                      <thead>
                        <tr class="table-secondary">
                          <th>견적번호<i class="mdi mdi-swap-vertical"></i></th>
                          <th>거래처명<i class="mdi mdi-swap-vertical"></i></th>
                          <th>거래처대표자명<i class="mdi mdi-swap-vertical"></i></th>
                          <th>거래처연락처<i class="mdi mdi-swap-vertical"></i></th>
                      ...
                      <tbody id="estimate_list">
                        ...
                        <tr>
                          ...
                          <td>${dto.em_name }</td>
                          <td class="text-success"><fmt:formatDate value="${dto.begin_date}" pattern="yyyy-MM-dd" /></td>
                        </tr>
                        </c:forEach>
                      </tbody>
						<tfoot>
                 ...
                 <div class="d-flex justify-content-end mt-3 mb-3">    
	                  <button type="button" class="btn btn-rounded btn-outline-twitter btn-fw btn-icon-text me-3" id="estimate_insert" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
	                       	<i class="mdi mdi-library-books btn-icon-preppend"></i>
	                       	견적서 작성
	                  </button>    
	                   <button type="button" class="btn btn-outline-facebook btn-rounded btn-icon-text" id="estimate_print" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                       		견적서목록 출력<i class="ti-printer btn-icon-append"></i>
	                  </button>   
                  </div>                                  
                  </div>
                </div>
