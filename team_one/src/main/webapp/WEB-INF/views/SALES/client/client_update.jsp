            ...
            <div id="result">
              ...
              <div class="form-group">
                <label for="exampleInputName1"><i class="mdi mdi-checkbox-marked-circle"></i>&nbsp;우편번호</label>
                   <div class="col-sm-2 row" style="flex-wrap: nowrap; padding-left: 1%; width: 40%;">
                      ...
                      <button type="button" onclick="execDaumPostcode()" class="button btn btn-secondary" style="padding:7px 8px;"><i class="icon-search"></i></button>
                      </div>
                    </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3 row" style="flex-wrap: nowrap; padding-left: 1%;">
                   <input type="text" class="form-control" maxlength="3" name="num1" value= "${fn:substring(dto.register_num,0,3)}" required oninput="numberMaxLength(this);"/> 
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="text" class="form-control" maxlength="2" name="num2" value= "${fn:substring(dto.register_num,3,5)}" required oninput="numberMaxLength(this);"/>
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="text" class="form-control" maxlength="5" name="num3" value= "${fn:substring(dto.register_num,5,10)}" required oninput="numberMaxLength(this);"/>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3 row" style="flex-wrap: nowrap; padding-left: 1%;">
                   <input type="text" class="form-control" maxlength="3" name="phone1" value= "${fn:substring(dto.cl_phone,0,3)}" required oninput="numberMaxLength(this);"/> 
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="text" class="form-control" maxlength="4" name="phone2" value= "${fn:substring(dto.cl_phone,3,7)}" required oninput="numberMaxLength(this);"/>
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="text" class="form-control" maxlength="4" name="phone3" value= "${fn:substring(dto.cl_phone,7,11)}" required oninput="numberMaxLength(this);"/>
                </div>
              </div> 
