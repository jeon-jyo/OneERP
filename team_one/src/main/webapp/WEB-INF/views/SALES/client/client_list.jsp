...
<script type="text/javascript">
   $(function(){
      ...
      $('#client_insert').click(function(){
	      ...
	      window.open(url, "client_insert", "menubar=no, width=800px, height=800px");  // (url, "별칭", size);  
       }); 
                    ...
                    <table class="table table-hover" id="client_list2" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                      ...
                      <c:forEach var="dto" items="${list}">
                        <tr>
                          ...
                          <td>${dto.client_id }</td>
                          <td>${dto.cl_name }</td>
                          <td>${fn:substring(dto.register_num,0,3)} - ${fn:substring(dto.register_num,3,5)} - ${fn:substring(dto.register_num,5,10)}</td>
                          <td>${dto.ceo_name }</td>
